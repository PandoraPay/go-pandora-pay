...
Options:
  ...
  --wallet-export-delegated-address=args             Export Delegated Address. Argument must be "account,nonce,path".
  --exit                                             Exit node.
`
