...
Options:
  ...
  --initialize-balance-decryptor                     Initialize Balance Decryptor.
  --exit                                             Exit node.
`
