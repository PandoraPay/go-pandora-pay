...
var (
	...
	NETWORK_SELECTED_DELEGATES_NODES = MAIN_NET_DELEGATES_NODES
...
func InitConfig() (err error) {
	...
	if globals.Arguments["--network"] == "mainet" {
		...
		NETWORK_SELECTED_DELEGATES_NODES = TEST_NET_DELEGATES_NODES
		...
		NETWORK_SELECTED_DELEGATES_NODES = DEV_NET_DELEGATES_NODES
	...
	if globals.Arguments["--delegates-allowed-enabled"] == "true" {
		DELEGATES_ALLOWED_ACTIVATED = true
	}
