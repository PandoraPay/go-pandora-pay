...
var (
	...
	NETWORK_SELECTED_DELEGATES_NODES = config_nodes.MAIN_NET_DELEGATES_NODES
...
func InitConfig() (err error) {
	...
	if globals.Arguments["--network"] == "mainet" {
		...
		NETWORK_SELECTED_DELEGATES_NODES = config_nodes.TEST_NET_DELEGATES_NODES
		...
		NETWORK_SELECTED_DELEGATES_NODES = config_nodes.DEV_NET_DELEGATES_NODES
