...
func Initialize(startMainCb func()) {
	...
	js.Global().Set("PandoraPay", js.ValueOf(map[string]interface{}{
		...
		"wallet": js.ValueOf(map[string]interface{}{
			...
			"updatePreviousValueWalletAddress":                 js.FuncOf(updatePreviousValueWalletAddress),
			"decodeBalanceIfMatchesPreviousValueWalletAddress": js.FuncOf(decodeBalanceIfMatchesPreviousValueWalletAddress),
			"getPrivateDataForDecodingBalanceWalletAddress":    js.FuncOf(getPrivateDataForDecodingBalanceWalletAddress),
		}),
