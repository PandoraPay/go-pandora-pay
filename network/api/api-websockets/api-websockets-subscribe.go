...
func (api *APIWebsockets) subscribe(conn *connection.AdvancedConnection, values []byte) (out []byte, err error) {
...
func (api *APIWebsockets) subscribedNotificationReceived(conn *connection.AdvancedConnection, values []byte) (out []byte, err error) {
