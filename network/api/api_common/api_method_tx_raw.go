...
func (api *APICommon) openLoadTxOnly(args *APITransactionRawRequest, reply *helpers.HexBytes) error {
...
func (api *APICommon) TxRaw(r *http.Request, args *APITransactionRawRequest, reply *helpers.HexBytes) error {
